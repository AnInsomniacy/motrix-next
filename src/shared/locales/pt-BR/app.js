export default {
  ...
  'close-action-message': 'O que você gostaria de fazer ao fechar a janela?',
  'close-action-minimize': 'Minimizar para a bandeja',
  'close-action-quit': 'Sair',
  'close-action-remember': 'Não perguntar novamente'
}
