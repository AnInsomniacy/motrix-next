export default {
  ...
  'close-action': 'Действие при закрытии',
  'close-action-ask': 'Всегда спрашивать',
  'close-action-minimize': 'Свернуть в трей',
  'close-action-quit': 'Выход',
  ...
  'use-native-traffic-lights': 'Использовать нативные кнопки macOS',
