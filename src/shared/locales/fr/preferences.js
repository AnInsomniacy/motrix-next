/** @fileoverview Locale messages for fr - preferences. */
export default {
  'basic': 'Général',
  'advanced': 'Avancé',
  'lab': 'Labo',
  ...
  'close-action': 'Action à la fermeture',
  'close-action-ask': 'Toujours demander',
  'close-action-minimize': 'Réduire dans la barre des tâches',
  'close-action-quit': 'Quitter',
