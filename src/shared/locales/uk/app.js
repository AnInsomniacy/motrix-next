...
export default {
  ...
  'close-action-message': 'Що ви хочете зробити при закритті вікна?',
  'close-action-minimize': 'Згорнути до лотка',
  'close-action-quit': 'Вийти',
  'close-action-remember': 'Більше не питати'
}
