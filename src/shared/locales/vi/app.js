...
export default {
  ...
  'close-action-message': 'Bạn muốn làm gì khi đóng cửa sổ?',
  'close-action-minimize': 'Thu nhỏ xuống khay hệ thống',
  'close-action-quit': 'Thoát',
  'close-action-remember': 'Không hỏi lại'
}
