export default {
  ...
  'proxy-unsupported-protocol': 'Giao thức proxy không được hỗ trợ. Aria2 Next chỉ hỗ trợ proxy HTTP (http/https/ftp).',
  'proxy-http-only-hint': 'Chỉ hỗ trợ proxy HTTP, không hỗ trợ proxy SOCKS',
  'proxy-request-scope-hint': 'Chỉ proxy các yêu cầu tải xuống, không proxy kết nối peer BT/ED2K',
  'user-agent-string': 'Chuỗi UA',
  port: 'Cổng lắng nghe',
  'auto-change-conflicting-ports': 'Tự động đổi cổng bị xung đột',
  'auto-change-conflicting-ports-hint': 'Áp dụng cho các cổng RPC, API tiện ích, BT, DHT và ED2K',
  ...
  'auto-select-all-bt-files-from-extension-hint': 'Khi bật, tác vụ BT sẽ bắt đầu âm thầm',
